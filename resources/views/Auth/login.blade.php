...
<body class="min-h-screen overflow-x-hidden bg-[radial-gradient(circle_at_top_left,_rgba(243,232,255,0.95),_transparent_38%),radial-gradient(circle_at_bottom_right,_rgba(237,233,254,0.92),_transparent_38%),linear-gradient(135deg,_#f8fafc_0%,_#ffffff_48%,_#f8fafc_100%)]">

<div class="min-h-screen lg:grid lg:grid-cols-2">
    <section class="relative flex items-center justify-center overflow-hidden bg-[linear-gradient(160deg,_#4c1d95_0%,_#6d28d9_55%,_#7c3aed_100%)] px-6 py-10 text-white lg:px-12">
        <div class="pointer-events-none absolute -left-24 top-10 h-72 w-72 rounded-full bg-white/10 blur-3xl"></div>
        <div class="pointer-events-none absolute bottom-0 right-0 h-80 w-80 rounded-full bg-fuchsia-300/10 blur-3xl"></div>

        <div class="relative w-full max-w-xl space-y-8 text-center lg:text-left">
            <div class="flex justify-center lg:justify-start">
                <div class="inline-flex items-center justify-center rounded-[26px] bg-white/12 px-5 py-4 shadow-[0_18px_50px_rgba(17,24,39,0.14)] ring-1 ring-white/15 backdrop-blur-md">
                    <img src="{{ asset('images/ceh_logo.png') }}" alt="Campus Event Hub" class="h-12 w-auto object-contain sm:h-16" />
                </div>
            </div>
            ...
            <ul class="space-y-6 pt-1 text-left">
                <li class="flex gap-4">
                    ...
                    <div>
                        ...
                        <p class="mt-1 hidden text-sm leading-6 text-white/72 sm:block">Organize events and attendance with less friction.</p>
                    </div>
                </li>
                <li class="flex gap-4">
                    ...
                    <div>
                        ...
                        <p class="mt-1 hidden text-sm leading-6 text-white/72 sm:block">Approve, monitor, and oversee campus clubs.</p>
                    </div>
                </li>
                <li class="flex gap-4">
                    <span class="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-white/14 text-sm">📚</span>
                    <div>
                        ...
                        <p class="mt-1 hidden text-sm leading-6 text-white/72 sm:block">Discover and join events from one dashboard.</p>
                    </div>
                </li>
            </ul>
        </div>
    ...
    <section class="flex items-center justify-center px-5 py-8 sm:px-8 lg:px-10 lg:py-12">
        <div class="w-full max-w-md">
            <div class="overflow-hidden rounded-[30px] bg-white/92 shadow-[0_25px_80px_rgba(17,24,39,0.14)] ring-1 ring-white/70 backdrop-blur-xl">
