                        ...
                        <div class="mb-8 pb-8 border-b border-gray-200">
                            ...
                            <div class="mt-6">
                                ...
                                <div style="position: relative;">
                                    <textarea id="eventDescription" name="description" rows="5" required placeholder="Tell us about your event..." class="w-full px-4 py-2 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-600 focus:border-purple-600 transition-all">{{ old('description') }}</textarea>
