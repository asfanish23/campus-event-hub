                    ...
                    <form method="POST" action="{{ route('event.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-8 pb-8 border-b border-gray-200">
                            ...
                            <div class="mt-6">
                                ...
                                <small style="color: #888; display: block; margin-top: 6px;">💡 Tip: Add any special details (free food, limited spots, prizes, etc.) above. Gemini will use them to create a better description!</small>
